...
$l['setting_ougc_threadcontributors_showavatars_guests_desc'] = 'Si se desactiva, se mostrara solo el nombre de usuario para los invitados.';
$l['setting_ougc_threadcontributors_count_posts'] = 'Mostrar Total de Mensajes';
$l['setting_ougc_threadcontributors_count_posts_desc'] = 'Si se desactiva, se mostrara el numero total de mensajes visibles por usuario.';
